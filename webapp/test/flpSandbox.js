		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Goods Supply",
									"targetURL": "#comsapgoodssupply-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapgoodssupply-display": {
								"semanticObject": "comsapgoodssupply",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.goodssupply",
									"url": sap.ui.require.toUrl("com/sap/goodssupply")
								}
							}
						}
					}
